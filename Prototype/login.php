        ...
        <form name="login" action="index_submit" method="get" accept-charset="utf-8">
          <ul>
            ...
            <li>
              ...
              <input type="email" name="login_usermail" placeholder="Enter E-mail Address" required>
            </li>
            <li>
              <label for="password" class="password">Password</label>
              <input type="password" name="login_password" placeholder="Enter Password" required>
            </li>
            <li class="login_button" name="login_button"> <a href="">Log in</a> </li>
            <li>
          ...
          <ul class="support-bg"id="support-qa" name="support-qa">
            <li>
              ...
              <h5>Learn how to <a href="">protent your account</a>!</h5>
