...
<div class="container">
  <div class="header"><img src="image/websitelogo-03.png" alt="" name="animal map logo" width="281" height="162" id="Insert_logo" style="background-color: #FFF; display:block;" /> </a> 
    ...
    <div class="accountbar-after">
      <ul class="accountbar-bar" id="account-bar" name="accountbar-bar">
  ...
  <div class="header-wrap">
    <ul class="group" id="header-one" name="header-one"> 
      ...
      <li><a href="pestRegister.php">Pest Register</a></li>
    </ul>
  </div>
  <!-- end .header-warp -->
  ...
  <div class="footer-bg">
    <ul id="footer-text" name="footer-text">
      <li class="footer-title"><a href="#">Blog</a> | <a href="#">Support</a> | <a href="#">About Us</a> | <a href="#">Contact Us</a> | <a href="#">Site Map</a> | <a href="#">News Letter</a> | <a href="#">Join Us</a> | <a href="#">Disclaimer</a> | <a href="#">Policies</a></li>
        ©2013 Dynamic Motion, INC. ALL RIGHTS RESERVED
      </ol>
      <ol class="footer-img">
        <img src="image/websignlayout-23.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/CompanyLogodesign-04.png">
      </ol>
    </ul>
  </div>
</div>
