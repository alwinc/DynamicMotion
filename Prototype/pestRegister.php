  ...
  <div class="Pest_U">
    <ul id="Pest_U-bg" name="Pest_U-bg">
      <section class="loginform cf">
        <form name="pest_register" action="pestregistration.php" method="get" accept-charset="utf-8">
          <ul>
            ...
            <li id = "id_update">
              ...
              <p id="show-id">
				<?php echo rand(0000001,9999999) 
				//Want to show the ID that auto-increment in database
				//for example will show the ID that the number of register is correct or not.
				?>
			  </p>
            </li>
